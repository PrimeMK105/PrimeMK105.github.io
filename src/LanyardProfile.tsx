...
const LanyardProfile: React.FC = () => {
  ...
  return (
    <div className="wrapper">
      <div className="card">
        <div className="card-title">@primemk105 &gt; home</div>
        <div className="user-profile">
          ...
          <div className="user-info">
            ...
            <div className="connections">
              <a title="github" href="https://github.com/PrimeMK105">
                <img
      ...
      <div className="card">
        <div className="card-title">@primemk105 &gt; about me</div>
        <div className="about-me">
          <header className="heading">about me</header>
          <div className="bio">
            <ul>
              <li>ϡ 9999 years old</li>
              <li>ϡ russian</li>
              <br/>
              <li>testing pages</li>
            </ul>
